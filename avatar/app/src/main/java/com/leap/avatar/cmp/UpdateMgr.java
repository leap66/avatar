...
//
// import com.leap.avatar.api_interface.update.usecase.CheckVersionCase;
// import com.leap.avatar.model.update.UpdateModel;
// import com.leap.mini.cmp.update.IUpdateListener;
// import com.leap.mini.cmp.update.UpdateDialog;
...
// new CheckVersionCase(null, "change", time, "1", appId, versionCode)
...
// // 获取下载文件的md5
// UPDATE_FILE_NAME =
// model.downloadUrl.substring(model.downloadUrl.lastIndexOf("/") + 1);
...
// } else {
// intent.setDataAndType(Uri.fromFile(new File(apkPath)),apkPath
