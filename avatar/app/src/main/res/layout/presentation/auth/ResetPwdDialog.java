...
public class ResetPwdDialog extends Dialog {
  ...
  private void initComponent(Context context) {
    binding = DataBindingUtil.inflate(LayoutInflater.from(context), com.leap.mini.R.layout.dialog_auth_reset_pwd,
        null, false);
    ...
    binding.codeEt.setOnKeyListener(new View.OnKeyListener() {
      ...
      public boolean onKey(View view, int keyCode, KeyEvent keyEvent) {
        if (keyCode == KeyEvent.KEYCODE_ENTER && keyEvent.getAction() == KeyEvent.ACTION_UP) {
          new com.leap.mini.presentation.auth.ResetPwdDialog.Presenter().onConfirm();
          return true;
        }
        return false;
      }
  ...
  public class Presenter {
    ...
    public void onSmsSend() {
      ...
      if (StringUtil.isMobileNO(mobile)) {
        ...
        DialogUtil.showError(getContext(), getContext().getString(com.leap.mini.R.string.register_phone_hint))
            .show();
      }
    }
